...
have L<qv> return an object in your derived class, do something like this:

  package My::Version;
  use base version;
  sub import {
      shift->SUPER::import(caller());
  }

You cannot simply inherit the C<import()> method, since that will not
export the qv() into the correct namespace.

Alternatively, you can duplicate the example in the test file 
F<t/02derived.t>:
