...
required for clarity, and will throw a warning if omitted.
...
B<strongly> discouraged in all circumstances.  In fact, if you leave off
the leading 'v' style, version.pm will throw a warning.  Also, bare
