...
A leading 'v' character is optional, but strongly recommended for clarity.
...
The internal structure of version objects is a blessed has with several
components:
...
v1.2 was used (in which case it will contain 'v1.2'.

=item qv

A logical the denotes whether this is a decimal or dotted-decimal version.
